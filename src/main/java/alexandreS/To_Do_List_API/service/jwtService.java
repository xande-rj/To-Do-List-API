...
public class jwtService {
    ...
    public  String gerarToken(Long id, String email, String nome){
        return Jwts.builder().setSubject(Long.toString(id)).setSubject(email).setSubject(nome).setIssuedAt(new Date()).
